...
if __name__ == "__main__":
    ...
    out_person = cv2.VideoWriter('out_person.avi', fourcc, 15.0, (432, 368))
    out_people = cv2.VideoWriter('out_people.avi', fourcc, 15.0, (432, 368))
    ...
    while True:
        ...
        send_image_to(image_single,sock_img,dsize=(432, 368))
        out_person.write(image_single)
        out_people.write(image_all)
        # send_image_to(image_all,sock_classifier,dsize=(432, 368))
